...
using Application = DbsBookingManagementService.Presentation.Constants.Application;

namespace DbsBookingManagementService.Startup
{
                        ...
                        if (contextFeature.Error is UserFriendlyException)
                        {
                            ...
                            switch (userFriendlyException.ErrorCode)
                            {
                                ...
                                case ErrorCode.InternalServerError:
                                    context.Response.StatusCode = (int)HttpStatusCode.InternalServerError;
                                    errorMessage = userFriendlyException.UserFriendlyMessage;
                                    errorCode = $"{Application.Name}.internal_server_error";
                                    break;
                                default:
