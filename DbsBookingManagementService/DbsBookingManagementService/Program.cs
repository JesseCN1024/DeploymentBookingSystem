using DbsBookingManagementService.Mappings;
using DbsBookingManagementService.Presentation.Filters;
using DbsBookingManagementService.Presentation.Validation;
using DbsBookingManagementService.Startup;
...
using System.Text;
using AutoMapper;
using DbsBookingManagementService.Presentation.Auth;
using Microsoft.AspNetCore.Authorization;
using Microsoft.OpenApi.Models;
using DbsBookingManagementService.Data;
using DbsBookingManagementService.Repositories.Interfaces;
using DbsBookingManagementService.Repositories.Inplementations;
using DbsBookingManagementService.Services.Interfaces;
using DbsBookingManagementService.Services.Implementations;
...
builder.Services.AddFluentValidation(fv => {
    ...
    fv.RegisterValidatorsFromAssemblyContaining<ValidatorEditBookingRequestDto>();
});
...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("AdminOrGeneral", policy =>
        policy.Requirements.Add(new CustomAuthorizationRequirement(new[] { "ADMIN", "GENERAL_USER" })));
