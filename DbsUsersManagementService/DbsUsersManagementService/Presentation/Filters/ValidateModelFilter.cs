...
namespace DbsUsersManagementService.Presentation.Filters
{
    ...
    public class ValidateModelFilter : IActionFilter
    {
        ...
        {
            var fluent = DbsUsersManagementService.Presentation.Constants.Constants.Validation.FluentValidationErrorKey;
